#ifndef _FEM3_AuxiliaryEquationSet_WeakGradient_impl_hpp_
#define _FEM3_AuxiliaryEquationSet_WeakGradient_impl_hpp_
...
FEM3::AuxiliaryEquationSet_WeakGradient<EvalT>::
...
// ***********************************************************************
template <typename EvalT>
void FEM3::AuxiliaryEquationSet_WeakGradient<EvalT>::
...
// ***********************************************************************
template < >
void FEM3::AuxiliaryEquationSet_WeakGradient<panzer::Traits::Jacobian>::
buildAndRegisterScatterEvaluators(PHX::FieldManager<panzer::Traits>& fm,
				  const panzer::FieldLibrary& field_library,
                                  const panzer::LinearObjFactory<panzer::Traits> & lof,
                                  const Teuchos::ParameterList& /* user_data */) const
