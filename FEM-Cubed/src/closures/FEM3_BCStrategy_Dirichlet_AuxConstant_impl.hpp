#ifndef FEM3_BC_STRATEGY_DIRICHLET_AuxCONSTANT_IMPL_HPP
#define FEM3_BC_STRATEGY_DIRICHLET_AuxCONSTANT_IMPL_HPP
...
FEM3::BCStrategy_Dirichlet_AuxConstant<EvalT>::
...
// ***********************************************************************
template <typename EvalT>
void FEM3::BCStrategy_Dirichlet_AuxConstant<EvalT>::
...
template < >
void FEM3::BCStrategy_Dirichlet_AuxConstant<panzer::Traits::Jacobian>::
buildAndRegisterGatherScatterEvaluators(PHX::FieldManager<panzer::Traits>& fm,
                                        const panzer::PhysicsBlock& side_pb,
                                        const panzer::LinearObjFactory<panzer::Traits> & lof,
                                        const Teuchos::ParameterList& user_data) const
