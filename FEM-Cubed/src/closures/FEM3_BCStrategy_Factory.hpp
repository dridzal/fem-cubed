#ifndef _FEM3_BCStrategy_Factory_hpp_
#define _FEM3_BCStrategy_Factory_hpp_
...
#include "FEM3_BCStrategy_Dirichlet_Constant.hpp"
#include "FEM3_BCStrategy_Dirichlet_AuxConstant.hpp"

namespace FEM3 {
  
  PANZER_DECLARE_BCSTRATEGY_TEMPLATE_BUILDER(FEM3::BCStrategy_Dirichlet_Constant,
					     BCStrategy_Dirichlet_Constant)
  PANZER_DECLARE_BCSTRATEGY_TEMPLATE_BUILDER(FEM3::BCStrategy_Dirichlet_AuxConstant,
