#ifndef FEM3_BCSTRATEGY_DIRICHLET_AUXCONSTANT_DECL_HPP
#define FEM3_BCSTRATEGY_DIRICHLET_AUXCONSTANT_DECL_HPP
...
#include "FEM3_BCStrategy_Dirichlet_AuxConstant_impl.hpp"
